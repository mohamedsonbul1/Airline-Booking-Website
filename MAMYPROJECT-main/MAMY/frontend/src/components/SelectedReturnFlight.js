...
getUserSign(){
  if(window.location.pathname.substring(35,59)=="666666666666666666666666"){
  ...
  render() {
    return (
        ...
        <li><Link to={"/UserHomePage/reservationList/"+(window.location.pathname.substring(35,59))} className="nav-link">Reservations</Link></li>
        <li><Link to={"/UserHomePage/editUser/"+(window.location.pathname.substring(35,59))} className="nav-link">Edit Personal Information</Link></li>
      ...
      <table className="table container">
        ...
        <Link to ={"/UserHomePage/Summary/"+window.location.pathname.substring(35)}> <button className='GButton'>View Flights Summary</button></Link>
        </div>
      </div>
      </div>
